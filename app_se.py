...
# UTÖKAD SURDEGSGUIDE
with st.sidebar.expander("📖 SURDEGSGUIDE & SKÖTSEL"):
    st.markdown("""
    ### 1. Matning (Uppfriskning)
    Använd förhållandet **1:1:1** för dagligt bruk:
    * 50g Surdegsgrund
    * 50g Vetemjöl (gärna ekologiskt/stenmalt)
    * 50g Ljummet vatten (ca 25-28°C)
    
    ### 2. Tecken på beredskap
    * **Volym:** Den ska minst dubblas i storlek.
    * **Utseende:** Full av bubblor, även små på ytan.
    * **Doft:** Mild, syrlig och lite fruktig (ej som vinäger).
    * **Flyt-test:** En sked surdeg ska flyta i ett glas vatten.

    ### 3. Förvaring
    * **I bänk:** Mata var 24:e timme om du bakar dagligen.
    * **I kyl:** Om du bakar sällan. Mata den, låt stå framme 1-2h tills den börjar bubbla, ställ sedan i kyl. Håller ca 1 vecka innan den behöver matas igen.

    ### 4. Inför bakning
    Ta ut grunden från kylen 12h innan. Mata upp den i den mängd receptet kräver + lite extra för att spara. Den är oftast som bäst 4–8 timmar efter matning.
    """)
